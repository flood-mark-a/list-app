...
@RestController
@RequestMapping("/api/list-kafka")
public class ListKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ListKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ListKafkaResource(KafkaProperties kafkaProperties) {
